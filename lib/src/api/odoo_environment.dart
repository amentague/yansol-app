...
import 'package:yansol/src/core/utils/config.dart';

import '../core/utils/network_connectivity.dart';
import '../core/storage/odoo_kv_hive.dart';
...
class OdooEnvironment {
  ...
  late OdooKvHive cache;

  /// Tracks current network state: online or offline
  late NetworkConnectivity netConnectivity;
  ...
  OdooEnvironment(
      ...
      required this.orpc,
      required this.cache,
      required this.netConnectivity})
      : callsLock = ReadWriteMutex(),
        dbName = db ?? odooDbName,
        logger = Logger() {
